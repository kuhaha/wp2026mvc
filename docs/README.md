...
- `app/views/View.php`：
  ...
  - `redirect($url)`：引数の**URL**へ画面を転送する。
    - URLは「`/クラスID/アクション/`」、「`/クラスID/アクション`」、「`/クラスID/アクション/?key=val`」、「`/クラスID/アクション?key=val`」となる。
    - 例えば、`/u/list/`、`/u/list`、`/u/edit/?id=s0001`、`/u/edit?id=s0001`
